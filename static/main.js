var
  ...
  correlation_subgroup_callback = function(result) {
    ...
    $("#table_correlation_detail").append('<thead><th>Category 1</th><th>Category 2</th><th>p-value</th><th>n</th><th>Mean 1</th><th>Mean 2</th><th>sd 1</th><th>sd 2</th><th>Test</th></tr></thead>');
    ...
    $('#table_correlation_detail').DataTable({
      ...
      "data": result["result"],
      "columnDefs": [
        { "targets": 0, "render": function ( data, type, full, meta ) { if (data.startsWith('_dx')) { return data.slice(4) } else { return data } } }, // field 1
        { "targets": 1, "render": function ( data, type, full, meta ) { if (data.startsWith('_dx')) { return data.slice(4) } else { return data } } }, // field 2
        { "targets": 2, "render": function ( data, type, full, meta ) { return data.toPrecision(3); } }, // p-value
        { "targets": 4, "render": function ( data, type, full, meta ) { if (data == '-') { return data } else { return data.toPrecision(3); } } }, // mean 1
        { "targets": 5, "render": function ( data, type, full, meta ) { if (data == '-') { return data } else { return data.toPrecision(3); } } }, // mean 2
        { "targets": 6, "render": function ( data, type, full, meta ) { if (data == '-') { return data } else { return data.toPrecision(3); } } }, // stdev 1
        { "targets": 7, "render": function ( data, type, full, meta ) { if (data == '-') { return data } else { return data.toPrecision(3); } } } // stdev 2
      ]
    });
